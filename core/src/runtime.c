...
static int initlibcurl(void)
{
   ...
   do {
      if((libcurl = dlopen(SO"libcurl.so.4", RTLD_NOW))) {}
      else if((libcurl = dlopen(SO"libcurl-gnutls.so.4", RTLD_NOW))) {}
      else if((libcurl = dlopen(SO"./libcurl.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibjpeg(void)
{
   ...
   do {
      if((libjpeg = dlopen(SO"libjpeg.so.8", RTLD_NOW))) {}
      else if((libjpeg = dlopen(SO"libjpeg.so.62", RTLD_NOW))) {}
      else if((libjpeg = dlopen(SO"./libjpeg.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibv4l2(void)
{
   ...
   do {
      if((libv4l2 = dlopen(SO"libv4l2.so.0", RTLD_NOW))) {}
      else  if((libv4l2 = dlopen(SO"./libv4l2.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibsqlite3(void)
{
   ...
   do {
      if((libsqlite3 = dlopen(SO"libsqlite3.so.0", RTLD_NOW))) {}
      else if((libsqlite3 = dlopen(SO"./libsqlite3.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibXi(void)
{
   ...
   do {
      if((libXi = dlopen(SO"libXi.so.6", RTLD_NOW))) {}
      else if((libXi = dlopen(SO"./libXi.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibXss(void)
{
   ...
   do {
      if((libXss = dlopen(SO"libXss.so.1", RTLD_NOW))) {}
      else if((libXss = dlopen(SO"./libXss.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibX11(void)
{
   ...
   do {
      if((libX11 = dlopen(SO"libX11.so.6", RTLD_NOW))) {}
      else if((libX11 = dlopen(SO"./libX11.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibglib(void)
{
   ...
   do {
      if((libglib = dlopen(SO"libglib-2.0.so.0", RTLD_NOW))) {}
      else if((libcurl = dlopen(SO"./libglib.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibgnomekeyring(void)
{
   ...
   do {
      if((libgnomekeyring = dlopen(SO"libgnome-keyring.so.0", RTLD_NOW))) {}
      else if((libgnomekeyring = dlopen(SO"./libgnome-keyring.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibpulse(void)
{
   ...
   do {
      if((libpulse = dlopen(SO"libpulse-simple.so.0", RTLD_NOW))) {}
      else if((libpulse = dlopen(SO"./libpulse-simple.so", RTLD_NOW))) {}
      else return ret;
...
static int initlibspeex(void)
{
   ...
   do {
      if((libspeex = dlopen(SO"libspeex.so.1", RTLD_NOW))) {}
      else if((libspeex = dlopen(SO"./libspeex.so", RTLD_NOW))) {}
      else return ret;
